...
https://github.com/huggingface/trl/blob/main/trl/trainer/utils.py#L56
"""

"""
Set up dataset and collator
"""
...
class CDataset(Dataset):
    ...
    def __getitem__(self, idx):
        return {"text": self.data[idx][0], "is_domain": self.data[idx][1]}
...
class DataCollatorForCompletionOnlyLM(DataCollatorForLanguageModeling):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.domain_text_field = domain_text_field
    ...
    def tokenize(self, examples):
        ...
        source = [example[self.domain_text_field] for example in examples]
    ...
    def torch_call(
        ...
        examples, source = self.tokenize(examples)
        batch = super().torch_call(examples)
        batch["is_domain"] = torch.tensor(source)
